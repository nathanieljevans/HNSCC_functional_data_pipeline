...
- is there a cleaned version of the plate data? eg... ID, inhibitor(s), dose, optical_density... 
...
hnscc.inhib <- read.csv2('./HNSCC_FUNCTIONAL_ASSAY_MAPPED_DOSE_RESPONSE_DATA/HNSCC_funcData_07_18_2019.csv', as.is=T, header=T, sep=',')
...
All our data is has been normalized by the photospectrometer software, indicated by `Blank490` designation. 
